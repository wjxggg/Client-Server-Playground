...
// [SECTION] Example App: Manipulating window titles / ShowExampleApm_pWindowTitles()
...
static void ShowExampleApm_pWindowTitles(bool* p_open);
...
struct ImGuiDemoWindowData
{
    ...
    bool ShowApm_pWindowTitles = false;
...
void ImGui::ShowDemoWindow(bool* p_open)
{
    ...
    if (demo_data.ShowApm_pWindowTitles)      { ShowExampleApm_pWindowTitles(&demo_data.ShowApm_pWindowTitles); }
...
static void DemoWindowMenuBar(ImGuiDemoWindowData* demo_data)
{
    ...
    if (ImGui::BeginMenuBar())
    {
        ...
        if (ImGui::BeginMenu("Examples"))
        {
            ...
            ImGui::MenuItem("Manipulating window titles", NULL, &demo_data->ShowApm_pWindowTitles);
...
static void ShowExampleApm_pWindowTitles(bool*)
{
    const ImGuiViewport* viewport = ImGui::GetMainViewport();
